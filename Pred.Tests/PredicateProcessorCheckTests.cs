...
{
    public class PredicateProcessorCheckTests
    {
        [Fact]
        public async Task ProcessAsync_WithTrueReturningCheckExpression_CompletesWithOneResult()
        {
            var processor = new PredicateProcessor(
                new Predicate(
                    "MyPredicate", Enumerable.Empty<PredicateParameter>(),
                    parameters => new PredicateExpression[]
                    {
                        PredicateExpression.Check(delegate{ return true; })
                    }
                )
            );

            var results = await processor.ProcessAsync("MyPredicate").ToListAsync();
        ...
        [Fact]
        public async Task ProcessAsync_WithFalseReturningCheckExpression_CompletesWithNoResults()
        {
            var processor = new PredicateProcessor(
                new Predicate(
                    "MyPredicate", Enumerable.Empty<PredicateParameter>(),
                    parameters => new PredicateExpression[]
                    {
                        PredicateExpression.Check(delegate{ return false; })
                    }
                )
            );
        ...
        [Fact]
        public async Task ProcessAsync_WithCheckExpression_CanReadInputParameter()
        {
            var callCount = 0;
            ...
            var processor = new PredicateProcessor(
                new Predicate(
                    ...
                    parameters => new PredicateExpression[]
                    {
                        PredicateExpression.Check(context =>
                        {
                            callCount++;
        ...
        [Fact]
        public async Task ProcessAsync_WithCheckExpression_CanReadOutputParameter()
        {
            var callCount = 0;
        ...
        [Fact]
        public async Task ProcessAsync_WithCheckExpression_CanReadBoundOutputParameter()
        {
            var callCount = 0;
            var callParameter = Parameter.Output<int>("output");
            var processor = new PredicateProcessor(
        ...
        [Fact]
        public async Task ProcessAsync_WithCheckExpression_CanReadVariable()
        {
            var callCount = 0;
            var callParameter = Parameter.Output<int>("output");
            var processor = new PredicateProcessor(
        ...
        [Fact]
        public async Task ProcessAsync_WithCallExpressionToPredicateWithCheckExpression_CanReadRelatedVariable()
        {
            var callCount = 0;
        ...
        [Fact]
        public async Task ProcessAsync_WithCallExpressionAndCheckExpression_CanReadRelatedVariableButNotFromInnerCall()
        {
            var callCount = 0;
