...
{
    public class CallPredicateExpression : PredicateExpression
    {
        public CallPredicateExpression(string name, IEnumerable<ValuePredicateExpression> parameters)
        {
        ...
        public CallPredicateExpression(string name, params ValuePredicateExpression[] parameters)
            : this(name, (IEnumerable<ValuePredicateExpression>)parameters)
        {
        }
